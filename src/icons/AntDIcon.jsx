export default function AntDIcon({ className }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
      <defs>
        ...
        >
          ...
          <stop offset={0.379} stopColor="#148eff"></stop>
        ...
        >
          ...
          <stop offset={0.415} stopColor="#f74a5c"></stop>
        ...
        >
          ...
          <stop offset={0.513} stopColor="#f74a5c"></stop>
          <stop offset={1} stopColor="#f51d2c"></stop>
        </linearGradient>
      </defs>
      <path
